            ...
            <section className="pb-20">
                <div className="container px-4 mx-auto">
                    <div className="max-w-2xl mx-auto mb-16 text-center">
                        <h2 className="text-4xl font-bold lg:text-5xl">Choose your best plan of <span className="font-bold">GYMZILLA</span></h2>
                    </div>
                    <div className="flex flex-wrap items-stretch">
                            ...
                            <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-gray-900">
                                ...
                                <ul className="flex-1 mb-6 text-gray-400">
                                    ...
                                    <li className="flex mb-2 space-x-2">
                                        ...
                                        <span>Self Directed Trainers</span>
                                    </li>
                                    ...
                                    <li className="flex mb-2 space-x-2">
                                        ...
                                        <span>Registration Fees : 2,500/BDT</span>
                                    </li>
                                    <li className="flex mb-2 space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="flex-shrink-0 w-6 h-6 text-violet-400">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                                        </svg>
                                        <span>Monthly Fee : 6,000/BDT</span>
                                    </li>
                                    <li className="flex mb-2 space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="flex-shrink-0 w-6 h-6 text-violet-400">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                                    ...
                                    <p>Total : 8,500/BDT</p>
                                    <p>Discount : 1,500/BDT</p>
                                    <p>Payable : 7,000/BDT</p>
                                </ul>
                        ...
                        <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                            <div className="flex flex-col p-6 space-y-6 rounded shadow sm:p-8 bg-violet-400 text-gray-900">
                                <div className="space-y-2">
                                    <h4 className="text-2xl font-bold">Half Yearly</h4>
                                ...
                                <ul className="flex-1 space-y-2">
                                    ...
                                    <li className="flex mb-2 space-x-2">
                                        ...
                                        <span>Monthly Fee : 12,000/BDT</span>
                                    </li>
                                    <li className="flex mb-2 space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="flex-shrink-0 w-6 h-6">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                                    ...
                                    <p>Total : 14,500/BDT</p>
                                    <p>Discount : 4,500/BDT</p>
                                    <p>Payable : 10,000/BDT</p>
                                </ul>
                        ...
                        <div className="flex w-full mb-8 sm:px-4 md:w-1/2 lg:w-1/3 lg:mb-0">
                            ...
                            <div className="space-y-2 text-white">
                                    ...
                                    <span className="text-6xl font-bold">$170
                                        <span className="text-sm tracking-wide">/month</span>
                                    </span>
                                </div>
                                <p className="mt-3 leading-relaxed text-gray-400">Etiam ac convallis enim, eget euismod dolor.</p>
                                <ul className="flex-1 mb-6 text-gray-400">
                                    ...
                                    <li className="flex mb-2 space-x-2">
                                        ...
                                        <span>High Profestional Trainers</span>
                                    </li>
                                    ...
                                    <li className="flex mb-2 space-x-2">
                                        ...
                                        <span>Monthly Fee : 24,000/BDT</span>
                                    </li>
                                    <li className="flex mb-2 space-x-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="flex-shrink-0 w-6 h-6 text-violet-400">
                                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd"></path>
                                    ...
                                    <p>Total : 26,500/BDT</p>
                                    <p>Discount : 9,500/BDT</p>
                                    <p>Payable : 17,000/BDT</p>
                                </ul>
                                <button type="button" className="inline-block px-5 py-3 font-semibold tracking-wider text-center rounded bg-violet-400 text-gray-900">Get Started</button>
                            </div>
                        </div>
